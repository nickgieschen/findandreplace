var findAndReplaceOptions = function () {
    ...
    //     };
    //
    //     kangoWrapper.getItem = function (name) {
    ...
    var layoutForm = function () {
        Storage.getItem("options", "[]").then(function (data) {
    ...
    var saveData = function () {
        ...
        Storage.setItem('options', values).then(function (data) {
    ...
    $(document).ready(function () {
        ...
        $("#addFormSectionButton").on("click", function (e) {
            e.preventDefault();
            addFormSection();
        });
